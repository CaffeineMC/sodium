...
----------
Sodium [SodiumVersion]() is a backport of modern Sodium 0.8.12 to Minecraft [MCVersion](). This experiment has graduated to alpha status. The degree to which we commit to supporting this branch will be determined by testing and by how well it works and integrates with the ecosystem. The quality of this version is expected to further improve it gets used, we discover quirks, and receive feedback. 
