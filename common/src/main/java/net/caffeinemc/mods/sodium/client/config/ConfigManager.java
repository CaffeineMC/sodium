...
public class ConfigManager {
    ...
    private static void registerConfigs(BiConsumer<ConfigEntryPoint, ConfigBuilder> registerMethod) {
        ...
        if (sodiumModOptions == null) {
            throw new RuntimeException("Sodium's config could not be found; the game is in a broken state most likely caused by an earlier error from another mod. Please check the game log (latest.log) for any errors first instead of reporting this as a Sodium-related crash.");
        }
