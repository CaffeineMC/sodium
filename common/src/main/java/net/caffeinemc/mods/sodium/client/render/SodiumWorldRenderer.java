...
public class SodiumWorldRenderer {
     ...
     */
    public void drawChunkLayer(ChunkSectionLayerGroup group, GpuSampler sampler, ChunkRenderMatrices matrices, double x, double y, double z) {
        if (group == ChunkSectionLayerGroup.OPAQUE) {
            this.renderSectionManager.renderLayer(matrices, DefaultTerrainRenderPasses.SOLID, sampler, x, y, z, this.lastFogParameters);
            this.renderSectionManager.renderLayer(matrices, DefaultTerrainRenderPasses.CUTOUT, sampler, x, y, z, this.lastFogParameters);
        } else if (group == ChunkSectionLayerGroup.TRANSLUCENT) {
            this.renderSectionManager.renderLayer(matrices, DefaultTerrainRenderPasses.TRANSLUCENT, sampler, x, y, z, this.lastFogParameters);
        }
    }
