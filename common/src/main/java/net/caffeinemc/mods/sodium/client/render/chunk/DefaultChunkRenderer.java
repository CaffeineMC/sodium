...
public class DefaultChunkRenderer extends ShaderChunkRenderer {
     ...
     */
    @Override
    public void render(ChunkRenderMatrices matrices, // todo, undo some of the changes in order to correctly implement pingpong buffering to allow for smoother visuals while updating meshes, no idea how i'm going to do this
