...
public abstract class LevelRendererMixin {
     ...
     * @return
     */
    @WrapOperation(method = { "addSkyPass", "lambda$addSkyPass$8" }, require = 1, at = @At(value = "INVOKE", target = "Lnet/minecraft/client/renderer/LevelRenderer;doesMobEffectBlockSky(Lnet/minecraft/client/Camera;)Z"))
